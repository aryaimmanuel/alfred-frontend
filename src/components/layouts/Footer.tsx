...
export default function Footer() {
  return (
    <footer className="w-full flex flex-col items-center justify-center gap-5 font-poppins text-white bg-[#1F2131]">
      <div className="w-full max-w-7xl p-5 flex flex-col items-center justify-between gap-9 md:flex-row">
        ...
        <nav className="w-full flex items-center md:max-w-[250px]">
        ...
        <div className="w-full flex flex-col gap-6 md:w-fit">
